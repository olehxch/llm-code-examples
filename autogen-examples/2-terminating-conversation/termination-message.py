...
agent_pm = ConversableAgent(
    ...
    Ask any questions to improve the estimate.
    Provide word STOP when the estimate is ready.
    """,
    llm_config=ollama_config,
    code_execution_config=False,
    function_map=None,
    human_input_mode='NEVER',
    is_termination_msg=lambda msg: "STOP" in msg["content"],
)
...
agent_dev = ConversableAgent(
    ...
    Provide word STOP when your estimate has been approved.
    """,
    llm_config=ollama_config,
    code_execution_config=False,
    function_map=None,
